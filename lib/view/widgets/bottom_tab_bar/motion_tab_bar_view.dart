...
//
// import 'motion_tab_controller.dart';
// import 'motion_tab_controller.dart' show DefaultMotionTabController;
//
...
//         assert(!(text != null &&
//             null != child)), // TODO(goderbauer): https://github.com/dart-lang/sdk/issues/34180
//         super(key: key);
//
...
//         (labelStyle ?? tabBarTheme.labelStyle ?? themeData.primaryTextTheme.bodyText1)!
...
//         (labelColor ?? tabBarTheme.labelColor) ?? themeData.primaryTextTheme.bodyText1!.color!;
...
//       _currentRect =
//           Rect.lerp(targetRect, _currentRect ?? targetRect, _indexChangeProgress(controller));
//     } else {
